...
export default function EditProduct({product,addproduct}) {
  ...
  const handleSubmit = async () => {
    console.log(product);
    await axios
      .post("https://hackathonecommerce.cyclic.app/UpdateProduct", product)
      .then((res) => {
      ...
      <div className="form-field">
        ...
        <form>
          ...
          <div className="input-field">
            ...
            <input
              type="text"
              value={product.ProductImgs[0].Img1}
              name="Img1"
            ...
            <input
              type="text"
              value={product.ProductImgs[0].Img2}
              name="Img2"
              onChange={handleChange1}
              className="input-box"
            ></input>
            ...
            <input
              type="text"
              value={product.ProductImgs[0].Img3}
              name="Img3"
              onChange={handleChange1}
              className="input-box"
            ></input>
